...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.ibb.co/D8wQ1YN/logo.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '000 BOT;Skl11;0;https://i.ibb.co/D8wQ1YN/logo.jpg;http://000official.ct.ws/group',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "000 BOT",
    BOT_NAME: process.env.BOT_NAME || '000 BOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Hasan;000 BOT MD bot;https://i.ibb.co/D8wQ1YN/logo.jpg' : process.env.AUDIO_DATA,
